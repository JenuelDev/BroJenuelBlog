...
<template>
    ...
    <div
        class="fixed sm:right-10 transition-all duration-300 right-0 bottom-0 sm:w-auto w-full z-99 filter backdrop-filter backdrop-blur-md bottom-[-350px] no-print"
