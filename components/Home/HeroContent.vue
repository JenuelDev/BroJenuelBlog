<template>
    ...
    >
        ...
        <div>
            <div
                class="light:bg-[#dee2e3] bg-[var(--primary)] md:w-360px sm:w-350px w-300px rounded-2xl z-8 md:h-360px sm:h-350px h-300px self-center overflow-hidden group relative mx-auto"
            >
