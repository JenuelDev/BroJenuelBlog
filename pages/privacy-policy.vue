...
<template>
    <OgImageStatic
        :description="`BroJenuel Privacy Policy`"
        :path="route.path"
        :title="`BroJenuel Privacy Policy`"
        appName="www.BroJenuel.com"
        component="DefaultOgImage"
    />
    <div class="content-render mt-100px min-h-80vh md:px-50px px-10px w-full max-w-1000px mx-auto">
        ...
        <ul>
            ...
            <li>
                <p>
                    ...
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to BroJenuel.
                </p>
            </li>
            <li>
                <p>
            ...
            <li>
                <p>
                    <strong>Website</strong> refers to BroJenuel, accessible from
                    <a href="https://www.brojenuel.com" rel="external nofollow noopener" target="_blank"
                        >https://www.brojenuel.com</a
                    >
                </p>
            </li>
            <li>
        ...
        <ul>
            <li>
                <p>By email: jenuelgnawed@outlook.com</p>
            </li>
            <li>
                <p>
                    By visiting this page on our website:
                    <a href="https://www.brojenuel.com/contact" rel="external nofollow noopener" target="_blank"
                        >https://www.brojenuel.com/contact</a
                    >
                </p>
            </li>
        </ul>
