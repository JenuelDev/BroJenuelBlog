...
<template>
    <NuxtLayout name="bloglayout">
        <div
            class="mt-70px min-h-100vh max-w-1100px mx-auto lg:px-10px sm:px-100px px-10px pb-5 gap-20"
        >
            <div class="mb-5">
                <div class="flex justify-between">
                    <div>
                        <span class="text-[var(--primary)] text-2xl font-800"
                            >Blogs</span
                        >
                    </div>
                    <form
            ...
            <div class="sm:col-span-9 col-span-11">
                <div class="min-h-[100vh]">
                    ...
                    >
                        ...
                        >
                            <div
                                class="h-200px flex items-center overflow-hidden rounded-lg"
                            >
                                <NuxtImg
                                    v-if="
                                        blog.cover_img &&
                                        !(
                                            blog.cover_img.indexOf('youtube') >
                                            -1
                                        )
                                    "
                                    :src="blog.cover_img"
